...
/**
 * Qwen (通义千问) query path. Qwen uses an OpenAI-compatible API via
 * DashScope, so we reuse the OpenAI message/tool converters and stream
 * adapter. Only the client (different base URL + API key) and model mapping
 * are Qwen-specific.
 */
